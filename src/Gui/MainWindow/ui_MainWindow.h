...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/hongbao"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutHongbaoAction = new QAction(MainWindow);
        m_aboutHongbaoAction->setObjectName(QStringLiteral("m_aboutHongbaoAction"));
        m_aboutHongbaoAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutHongbaoAction);
        ...
        QObject::connect(m_aboutHongbaoAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutHongbaoAction->setText(QApplication::translate("MainWindow", "About Hongbao", 0));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND HONGBAO", 0));
