...
const char COMMUNITY_FORUM_URL[] = "https://hongbaoblockchain.org";
const char REPORT_ISSUE_URL[] = "https://hongbaoblockchain.org/contact";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Hongbao Wallet %1").arg(Settings::instance().getVersion()));
